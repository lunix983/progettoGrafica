...
class Car{
  ...
  void RenderAllParts(bool usecolor, int carColor) const;
...
public:
  ...
  void Render(int carColor) const; // disegna a schermo
  int contaColpito();
  void rallenta();
  //void Render(float s, int color) const; // disegna a schermo
